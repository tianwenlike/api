...
var mui = function (a, b) {
    ...
    i.uuid = 0, i.data = {}, i.extend = function () {
        ...
        for ("boolean" == typeof h && (l = h, h = arguments[j] || {}, j++), "object" == typeof h || i.isFunction(h) || (h = {}), j === k && (h = this, j--); j < k; j++) if (null != (a = arguments[j])) for (c in a) d = h[c], e = a[c], h !== e && (l && e && (i.isPlainObject(e) || (f = i.isArray(e))) ? (f ? (f = !1, g = d && i.isArray(d) ? d : []) : g = d && i.isPlainObject(d) ? d : {}, h[c] = i.extend(l, g, e)) : e !== b && (h[c] = e));
        return h
    }, i.noop = function () {
...
!function (a, b) {
            ...
            b.addEventListener("focusin", function (d) {
                if (!(a.os.plus && window.plus && plus.webview.currentWebview().children().length > 0)) {
                    ...
                    if (e.tagName && ("TEXTAREA" === e.tagName || "INPUT" === e.tagName && ("text" === e.type || "search" === e.type || "number" === e.type))) {
                        ...
                        if (f) {
                            var h = b.body.scrollHeight, i = b.body.scrollLeft;
                            setTimeout(function () {
                                window.scrollTo(i, h)
                            }, 20)
                        }
        ...
        switch (c.type) {
            ...
            case a.EVENT_MOVE:
                if (a.options.gestureConfig.pinch) {
                    ...
                    var g = d.scale, h = d.rotation, i = void 0 === d.lastScale ? 1 : d.lastScale, j = 1e-12;
            ...
            if (d || e) {
                ...
                if (f) {
                    ...
                    1 === g.length && (a.os.plus ? d && "circle" == c.down.style ? a.plusReady(function () {
                        ...
                        if (!1 === window.__NWin_Enable__) g.pullRefresh(c); else {
                            if (e) {
                                var f = {};
    ...
    a.ajax = function (d, e) {
        ...
        var m = f.accepts[h && h.toLowerCase()], n = {}, r = function (a, b) {
            n[a.toLowerCase()] = [a, b]
        }, s = /^([\w-]+:)\/\//.test(f.url) ? RegExp.$1 : b.location.protocol, t = f.xhr(f);
        ...
        if (r("Accept", m || "*/*"), (m = f.mimeType || m) && (m.indexOf(",") > -1 && (m = m.split(",", 2)[0]), t.overrideMimeType && t.overrideMimeType(m)), (f.contentType || !1 !== f.contentType && f.data && "GET" !== f.type.toUpperCase()) && r("Content-Type", f.contentType || "application/x-www-form-urlencoded"), f.headers) for (var w in f.headers) r(w, f.headers[w]);
        if (t.setRequestHeader = r, t.onreadystatechange = function () {
            if (4 === t.readyState) {
                ...
                if (t.status >= 200 && t.status < 300 || 304 === t.status || 0 === t.status && d && t.responseText) {
                    ...
                    var e = t.status ? "error" : "abort", g = t.statusText || null;
        ...
        return h.length > 1 && (i.url = h[0], e = h[1]), i.success = function (a) {
            if (e) {
                ...
                if (d && d.length > 0) for (var h = 0, i = d.length; h < i; h++) c.appendChild(d[h]);
    ...
    var e = "mui-scroll", f = "mui-scrollbar", g = "mui-scrollbar-indicator", h = f + "-vertical",
        i = f + "-horizontal", j = "mui-active", k = {
            ...
            init: function (b, c) {
                ...
                for (var a = this.wrapper.querySelectorAll("." + e), b = 0, c = a.length; b < c; b++) if (a[b].parentNode === this.wrapper) {
                    this.scroller = a[b];
                    break
                }
        ...
        l = a.Slider = a.Scroll.extend({
            init: function (b, c) {
                ...
                if (b.target === c.wrapper) {
                    ...
                    var l = d.slideNumber;
                    if (c.loop && (l += 1), !c.wrapper.classList.contains("mui-segmented-control")) for (var g = 0, h = f.length; g < h; g++) {
                        var k = f[g];
                    ...
                    if (m) {
                        ...
                        if (n.length > 0) for (var g = 0, h = n.length; g < h; g++) n[g].classList[g === d.slideNumber ? "add" : "remove"](i); else {
                            var o = m.querySelector(".mui-number span");
                            if (o) o.innerText = d.slideNumber + 1; else for (var p = m.querySelectorAll(".mui-control-item"), g = 0, h = p.length; g < h; g++) p[g].classList[g === d.slideNumber ? "add" : "remove"](i)
                        }
                    }
                    b.stopPropagation()
                }
                ...
                for (var a = this.wrapper.querySelectorAll("." + d), b = 0, c = a.length; b < c; b++) if (a[b].parentNode === this.wrapper) {
                    this.scroller = a[b];
                    break
                }
    ...
    a.os.plus && a.plusReady(function () {
        if (!1 !== window.__NWin_Enable__) {
            var c = "mui-visibility", d = "mui-hidden", e = "mui-block", f = "mui-pull-caption",
                g = "mui-pull-caption-down", h = "mui-pull-caption-refresh", i = "mui-pull-caption-nomore",
                j = a.Class.extend({
                    init: function (a, b) {
            ...
            a.fn.pullRefresh_native = function (c) {
                ...
                var f = null, g = c.webviewId && c.webviewId.replace(/\//g, "_"),
    ...
    var f = "mui-control-item", g = "mui-segmented-control-vertical", h = "mui-control-content", i = "mui-tab-item",
        j = function (a, b) {
    ...
    var F = {
        handleEvent: function (a) {
            ...
            if (z) {
                ...
                var l;
                if (buttonsLeft && buttonsLeft.length > 0 && buttonsLeft !== g) for (var k = 0, m = buttonsLeft.length; k < m; k++) {
                    var n = buttonsLeft[k];
        ...
        q = function () {
            ...
            var j = a.qsa("." + m, h), l = h.querySelector("." + k + " input"), n = {
                element: h, close: function (a, b) {
                    if (h) {
                        if (!1 === (e && e({index: a || 0, value: l && l.value || ""}))) return;
        ...
        g = ".mui-progressbar", h = function (b) {
            ...
            if ("number" == typeof h && (j = i, i = h, h = "body"), h = a(h || "body"), 0 !== h.length) {
                ...
                if (h.classList.contains(c)) l = h; else {
                    ...
                    if (m) for (var n = 0, o = m.length; n < o; n++) {
                        var p = m[n];
                        if (p.parentNode === h) {
                            l = p;
                            break
    ...
    var d = "mui-icon", e = "mui-icon-clear", f = "mui-icon-speech", g = "mui-icon-eye", h = "mui-input-row",
        i = "mui-placeholder", j = "mui-tooltip", k = "mui-hidden", l = "mui-focusin", m = "." + e, n = "." + f,
        o = "." + g, p = "." + i, q = "." + j, r = function (a) {
    ...
    s.prototype.init = function () {
        ...
        var c = [];
        return this.each(function () {
            var b = null, d = [], e = r(this.parentNode);
    ...
    var b = "ontouchstart" in document, c = b ? "tap" : "click", d = "change",
        e = ".mui-btn-numbox-plus,.mui-numbox-btn-plus", f = ".mui-btn-numbox-minus,.mui-numbox-btn-minus",
        g = ".mui-input-numbox,.mui-numbox-input", h = a.Numbox = a.Class.extend({
            init: function (b, c) {
                var d = this;
